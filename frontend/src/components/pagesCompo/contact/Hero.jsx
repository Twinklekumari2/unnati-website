...
const Hero = () => {
  return (
    <div className="w-full min-h-screen bg-gray-100">
      ...
      <div className="relative px-10 py-10 flex flex-row gap-10 bg-gray-300 rounded-lg w-full">
        <div className="bg-gray-300 shadow-md rounded-lg w-full px-5 py-10">
            <h1 className="text-2xl font-extrabold mb-6 px-20 py-2">VISIT US HERE</h1>
            <h1 className="text-xl font-bold mb-6 px-20">HEAD OFFICE</h1>
            <h2 className="text-xl mb-3 px-20">
                Indian Institute of Information Technology, Bhagalpur, Sabour, Bihar
            </h2>
            <h2 className="text-xl mb-3 px-20">
                Pin Code: 812210
            </h2>
        ...
        <div className="bg-gray-300 shadow-md rounded-lg w-full px-10 py-10">
            
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d10374.130889500819!2d87.04202000000002!3d25.25735000000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2sin!4v1776687662276!5m2!1sen!2sin" 
            width="600" 
            height="450" 
            style={{border:0}}
            allowfullscreen="" 
