...
const Testimonial3 = () => {
  return (
    <section className="w-full flex justify-center items-center py-20 bg-linear-to-b from-white via-gray-50 to-white overflow-hidden">
        ...
        <img
          src={cloudinaryImage2("4_wafb1x")}
          alt="testimonial"
          className="relative w-screen h-30 object-cover rounded-[28px] shadow-xl transition-all duration-500 group-hover:-translate-y-2"
        />
      </div>
    </div>
  </div>
